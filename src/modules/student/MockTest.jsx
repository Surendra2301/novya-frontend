...
//   // FIXED: Handle Hint function with immediate persistence
//   const handleHint = () => {
//     if (rewardPoints < 5) {
...
//                       <span>(For passing the test)</span>
//                     </div>
...
//         setShowHint(true);
//         // MARK: UPDATED - Use centralized function to deduct points with history
//         addRewardPointsWithHistory(-5, t('hintUsed'), 'mock_test_hint');
//       } else {
//         // Fallback: If no hint in data, show default message
//         setCurrentHint(t('noHintAvailable'));
//         setShowHint(true);
//         // MARK: UPDATED - Use centralized function to deduct points with history
//         addRewardPointsWithHistory(-5, t('hintUsed'), 'mock_test_hint');
//       }
        ...
        <div className={`modern-quiz-container ${isFullScreen ? "fullscreen-mode" : ""}`}>
          ...
          <div className="quiz-side-panel">
            ...
            <div className="reward-points-section">
              <span className="reward-points-label">{t('rewardPoints')}</span>
              <span className="reward-points-value">{rewardPoints}</span>
            </div>
            ...
            <div className="side-panel-nav">
              {quiz.map((_, index) => (
                <button
                  key={index}
                  className={`side-nav-dot ${index === currentQ ? 'active' : ''} ${
                    userAnswers[index] ? 'answered' : ''
                  } ${skippedQuestions.includes(index) ? 'skipped' : ''}`}
                  onClick={() => goToQuestion(index)}
                >
