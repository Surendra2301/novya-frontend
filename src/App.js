...
import TeacherHeader from './modules/teacher/Header';
import UserList from './modules/teacher/Userlist';
...
function App() {
  ...
  />
          ...
          <Route path="/teacher/userlist" element={
            <ProtectedRoute>
              <RoleRoute requiredRole="teacher">
          ...
          <Route path="/teacher/student-details" element={
            <ProtectedRoute>
              <RoleRoute requiredRole="teacher">
                <div style={{ marginLeft: '250px', padding: '0' }}>
                  <StudentDetails />
          ...
          <Route path="/teacher/parent-details" element={
            <ProtectedRoute>
              <RoleRoute requiredRole="teacher">
                <div style={{ marginLeft: '250px', padding: '0' }}>
                  <ParentDetails />
